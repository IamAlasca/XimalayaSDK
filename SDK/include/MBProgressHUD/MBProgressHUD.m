...
- (void)showUsingAnimation:(BOOL)animated {
	...
	if (animated) {
#if 1
        UIViewAnimationOptions  animationOpt = UIViewAnimationOptionTransitionNone|UIViewAnimationOptionCurveEaseInOut|UIViewAnimationOptionBeginFromCurrentState;
        if(self.isUserActive){
            animationOpt |= UIViewAnimationOptionAllowUserInteraction;
        }
